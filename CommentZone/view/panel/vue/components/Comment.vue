<template>
  <div class="card p-2 mb-4 border-0 shadow-sm bg-box">
      ...
      <div class="row">
        ...
        <div class="col col-sm-auto p-0">
          <div class="row">
            ...
            <div class="col-auto text-pale text-nowrap">
    ...
    <div class="card-footer bg-transparent border-0 ms-5">
      <!-- <button
        class="dropdown-toggle btn btn-dark-blue shadow-sm btn-sm my-1 comment-control-toggle"
        :class="dropdownToggle(575.98)"
        @click="actionShowControl(comment.id)"
        type="button"
      >
        {{ $store.state.language.controls }}
      </button> -->
      <div class="row flex-nowrap">
        <div class="col-10 col-md-auto overflow-hidden dropdown comment-control-menu">
          <div class="text-nowrap d-inline" v-menuHidden>
            <router-link
              class="btn shadow-sm btn-sm text-dark my-1"
              :class="comment.newReportsCount > 0 ? 'btn-warning' : 'btn-dark-blue'"
              data-menu-class="menu-item-reports"
            ...
            <button
              ...
              data-menu-class="menu-item-approve"
            ...
            <button
              ...
              data-menu-class="menu-item-recover"
            ...
            <button
              ...
              data-menu-class="menu-item-readit"
              v-if="
            ...
            <router-link class="btn btn-dark-blue shadow-sm btn-sm my-1" data-menu-class="menu-item-chain" :to="'/chain/' + (comment.mid === 0 ? comment.id : comment.mid)">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
            ...
            <button
              ...
              data-menu-class="menu-item-reply"
            ...
            <button
              type="button"
              class="btn btn-dark-blue shadow-sm btn-sm my-1"
              data-menu-class="menu-item-edit"
              v-if="
                currentUser.permission.indexOf('manage_comments') !== -1 ||
            ...
            <button
              type="button"
              class="btn btn-dark-blue shadow-sm btn-sm my-1"
              data-menu-class="menu-item-delete"
              v-if="
                comment.posted === 1 &&
                (currentUser.permission.indexOf('manage_comments') !== -1 ||
        ...
        <div class="col-2 col-md-auto">
          ...
          <ul class="dropdown-menu dropdown-menu-dark">
            <li class="menu-item-reports d-none" v-if="currentUser.permission.indexOf('manage_comments') !== -1 && comment.newReportsCount > 0">
              <router-link
                class="dropdown-item"
                :class="comment.newReportsCount > 0 ? 'btn-warning' : 'btn-dark-blue'"
                :to="'/reports/' + comment.id"
            ...
            <li class="menu-item-approve d-none" v-if="currentUser.permission.indexOf('manage_comments') !== -1 && comment.moderation === 1">
              <button type="button" class="dropdown-item" @click="approve">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
            ...
            <li class="menu-item-recover d-none" v-if="currentUser.permission.indexOf('manage_comments') !== -1 && comment.posted === 0">
              <button type="button" class="dropdown-item" @click="recoverConfirm">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
            ...
            <li class="menu-item-readit d-none"
              v-if="
                currentUser.permission.indexOf('manage_comments') !== -1 &&
                comment.new === 1 &&
                comment.posted === 1 &&
              ...
              "
            >
              <button type="button" class="dropdown-item" @click="read">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
            ...
            <li class="menu-item-chain d-none">
              <router-link class="dropdown-item" :to="'/chain/' + (comment.mid === 0 ? comment.id : comment.mid)">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
            ...
            <li class="menu-item-reply d-none" v-if="currentUser.permission.indexOf('answer_comment') !== -1 && comment.moderation !== 1">
              <button type="button" class="dropdown-item" @click="ActionInputOpenedToggle(comment.prefixId)">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-reply" viewBox="0 0 16 16">
                  <path
                    d="M6.598 5.013a.144.144 0 0 1 .202.134V6.3a.5.5 0 0 0 .5.5c.667 0 2.013.005 3.3.822.984.624 1.99 1.76 2.595 3.876-1.02-.983-2.185-1.516-3.205-1.799a8.74 8.74 0 0 0-1.921-.306 7.404 7.404 0 0 0-.798.008h-.013l-.005.001h-.001L7.3 9.9l-.05-.498a.5.5 0 0 0-.45.498v1.153c0 .108-.11.176-.202.134L2.614 8.254a.503.503 0 0 0-.042-.028.147.147 0 0 1 0-.252.499.499 0 0 0 .042-.028l3.984-2.933zM7.8 10.386c.068 0 .143.003.223.006.434.02 1.034.086 1.7.271 1.326.368 2.896 1.202 3.94 3.08a.5.5 0 0 0 .933-.305c-.464-3.71-1.886-5.662-3.46-6.66-1.245-.79-2.527-.942-3.336-.971v-.66a1.144 1.144 0 0 0-1.767-.96l-3.994 2.94a1.147 1.147 0 0 0 0 1.946l3.994 2.94a1.144 1.144 0 0 0 1.767-.96v-.667z"
                  />
            ...
            <li class="menu-item-edit d-none"
              v-if="
                currentUser.permission.indexOf('manage_comments') !== -1 ||
                (comment.authorId === currentUser.id &&
                  currentUser.permission.indexOf('update_comment') !== -1 &&
              ...
              "
            >
              <button type="button" class="dropdown-item" @click="ActionEditOpenedToggle(comment.prefixId)">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                  <path
                    d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"
                  />
            ...
            <li class="menu-item-delete d-none"
              v-if="
                comment.posted === 1 &&
                (currentUser.permission.indexOf('manage_comments') !== -1 ||
                  (comment.authorId === currentUser.id && currentUser.permission.indexOf('delete_comment') !== -1))
              "
            >
              <button type="button" class="dropdown-item" @click="deleteConfirm">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                  <path
                    d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"
                  />
            ...
            <li
              v-if="currentUser.permission.indexOf('manage_comments') !== -1 && comment.reportsCount > 0 && comment.newReportsCount === 0"
            >
...
export default {
  ...
  methods: {
    actionShowControl(id) {
      this.showControl = this.showControl !== id ? id : 0;
      ...
      document.addEventListener(
        ...
        (e) => {
          ...
          if (targetClass.indexOf("comment-control-toggle") === -1 && targetClass.indexOf("comment-control-menu") === -1) {
            this.showControl = 0;
          }
        },
        false
    ...
    dropdownToggle(width) {
      if (this.screenWidth > width) {
        return "d-none";
      }
    },
    dropdownMenu(width, id) {
      let strClass = "";

      if (this.screenWidth <= width) {
        strClass += "dropdown-menu p-4 bg-dark";

        if (this.showControl === id) {
          strClass += " d-grid show";
        }
      }
